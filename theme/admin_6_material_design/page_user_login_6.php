        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 login-container bs-reset">
                    <img class="login-logo login-6" src="../assets/pages/img/login/my-login-logo.png" />
                        ...
                        <div class="row bs-reset">
                            ...
                            <div class="col-xs-7 bs-reset">
                                <div class="login-copyright text-right">
                                    <p>Copyright &copy; Shinigami 2018</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<![endif]-->
        ...
        <script src="../My JS/login.js" type="text/javascript"></script>
