                ...
                <div class="page-fixed-main-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="portlet light profile-sidebar-portlet bordered">
                                    ...
                                    <div class="profile-usermenu">
                                        <ul class="nav">
                                            ...
                                            <li>                                         
                                                <a  id="account_settings" href="page_user_profile_1_account.html">
                                                    <i class="icon-settings"></i> Account Settings 
                                                </a>                                                  
                                            </li>
                                            <li>
                                                <a href="page_user_profile_1_help.html" id="help">
                            ...
                            <div class="profile-data" id="profile-data-1">
...
<![endif]-->
        ...
        <!-- END CORE PLUGINS -->
        <!-- <script src="../My JS/SwitchPageAccout.js" type="text/javascript"></script> -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
